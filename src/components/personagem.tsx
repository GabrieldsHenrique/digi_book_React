    ...
    return (
      <>
        ...
        >
          ...
          <Dialog.Panel className="p-3 grid grid-cols-12 gap-4 bg-blue-light rounded-2xl w-[50rem] fonte  justify-center items-end">

                <picture className="col-span-2 justify-center items-center"><img src={data.img.src} alt={data.img.alt}/></picture>
                ...
                <div className="col-span-4 ">
                    ...
                    <div className="col-span-4 grid grid-rows-6 gap-2 h-72 items-center">
                      <p className=" text-white text-[1rem] border-2 rounded-xl px-2 py-1 shadow-2xl  bg-[#4778A6]"
                      >Idade: {data.idade}</p>
                      <p className=" text-white text-[1rem] border-2 rounded-xl px-2 py-1 shadow-2xl  bg-[#4778A6]"
                      >Ator: {data.ator}</p>
                      <p className=" text-white text-[1rem] border-2 rounded-xl   px-2 py-1 shadow-2xl  bg-[#4778A6]"
                      ...
                      <p className=" text-white text-[1rem] border-2 rounded-xl   px-2 py-1 shadow-2xl  bg-[#4778A6]"
                      >Nascionalidade: {data.nascionalidade}</p>
                      <p className=" text-white text-[1rem] border-2 rounded-xl   px-2 py-1 shadow-2xl  bg-[#4778A6]"
